...
#ifndef WIN32_GENS_WINDOW_MENU_H
#define WIN32_GENS_WINDOW_MENU_H
...
#define ID_SOUND_STEREO			0x4002
#define ID_SOUND_Z80			0x4003
#define ID_SOUND_YM2612			0x4004
#define ID_SOUND_YM2612_IMPROVED	0x4005
#define ID_SOUND_DAC			0x4006
#define ID_SOUND_DAC_IMPROVED		0x4007
#define ID_SOUND_PSG			0x4008
#define ID_SOUND_PSG_IMPROVED		0x4009
#define ID_SOUND_PCM			0x400A
#define ID_SOUND_PWM			0x400B
#define ID_SOUND_CDDA			0x400C
#define ID_SOUND_WAVDUMP		0x400D
#define ID_SOUND_GYMDUMP		0x400E
#define ID_SOUND_RATE			0x4100 // Same as ID_SOUND_RATE_11025
#define ID_SOUND_RATE_11025		(ID_SOUND_RATE + 0)
#define ID_SOUND_RATE_22050		(ID_SOUND_RATE + 1)
#define ID_SOUND_RATE_44100		(ID_SOUND_RATE + 2)
#define ID_SOUND_RATE_16000		(ID_SOUND_RATE + 3)
#define ID_SOUND_RATE_24000		(ID_SOUND_RATE + 4)
#define ID_SOUND_RATE_48000		(ID_SOUND_RATE + 5)
...
#endif /* GENS_CDROM */
#define ID_OPTIONS_LOADCONFIG		0x5006
#define ID_OPTIONS_SAVECONFIGAS		0x5007
#define ID_OPTIONS_SEGACDSRAMSIZE	0x5100 // Same as ID_OPTIONS_SEGACDSRAMSIZE_NONE
#define ID_OPTIONS_SEGACDSRAMSIZE_NONE	(ID_OPTIONS_SEGACDSRAMSIZE + 0)
#define ID_OPTIONS_SEGACDSRAMSIZE_8KB	(ID_OPTIONS_SEGACDSRAMSIZE + 1)
#define ID_OPTIONS_SEGACDSRAMSIZE_16KB	(ID_OPTIONS_SEGACDSRAMSIZE + 2)
#define ID_OPTIONS_SEGACDSRAMSIZE_32KB	(ID_OPTIONS_SEGACDSRAMSIZE + 3)
#define ID_OPTIONS_SEGACDSRAMSIZE_64KB	(ID_OPTIONS_SEGACDSRAMSIZE + 4)
...
#endif /* WIN32_GENS_WINDOW_MENU_H */
