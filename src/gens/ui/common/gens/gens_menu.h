...
#define IDM_GRAPHICS_OPENGL_RES		0x2100
#define IDM_GRAPHICS_OPENGL_RES_320	0x2101 // 320x240
#define IDM_GRAPHICS_OPENGL_RES_640	0x2102 // 640x480
#define IDM_GRAPHICS_OPENGL_RES_800	0x2103 // 800x600
#define IDM_GRAPHICS_OPENGL_RES_1024	0x2104 // 1024x768
#define IDM_GRAPHICS_OPENGL_RES_CUSTOM	0x2105 // Custom

#define IDM_GRAPHICS_BPP		0x2200
#define IDM_GRAPHICS_BPP_15		0x2201 // 15-bit color (555)
#define IDM_GRAPHICS_BPP_16		0x2202 // 16-bit color (565)
#define IDM_GRAPHICS_BPP_32		0x2203 // 32-bit color

#define IDM_GRAPHICS_RENDER		0x2300
#define IDM_GRAPHICS_RENDER_NORMAL	0x2301
#define IDM_GRAPHICS_RENDER_DOUBLE	0x2302

#define IDM_GRAPHICS_FRAMESKIP		0x2800
...
#define IDM_CPU_DEBUG_SEGACD_SEPARATOR	0x3104
#define IDM_CPU_DEBUG_SEGACD_MC68000	0x3105
#define IDM_CPU_DEBUG_SEGACD_CDC	0x3106
#define IDM_CPU_DEBUG_SEGACD_GFX	0x3107
#define IDM_CPU_DEBUG_32X_SEPARATOR	0x3108
#define IDM_CPU_DEBUG_32X_MSH2		0x3109
#define IDM_CPU_DEBUG_32X_SSH2		0x310A
#define IDM_CPU_DEBUG_32X_VDP		0x310B
#endif /* GENS_DEBUGGER */
