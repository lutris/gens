...
#define IDM_GRAPHICS_OPENGL_ORTHOPROJ	(IDM_GRAPHICS_MENU + 5)
#define IDM_GRAPHICS_COLORADJUST	(IDM_GRAPHICS_MENU + 6)
#define IDM_GRAPHICS_SPRITELIMIT	(IDM_GRAPHICS_MENU + 7)
#define IDM_GRAPHICS_SCREENSHOT		(IDM_GRAPHICS_MENU + 8)
...
#define IDM_GRAPHICS_INTREND		0x2500
#define IDM_GRAPHICS_INTREND_EVEN	(IDM_GRAPHICS_INTREND + 1)
#define IDM_GRAPHICS_INTREND_ODD	(IDM_GRAPHICS_INTREND + 2)
#define IDM_GRAPHICS_INTREND_FLICKER	(IDM_GRAPHICS_INTREND + 3)
#define IDM_GRAPHICS_INTREND_2X		(IDM_GRAPHICS_INTREND + 4)

#define IDM_GRAPHICS_FRAMESKIP		0x2600
...
#define IDM_OPTIONS_SEGACDSRAMSIZE_128KB	(IDM_OPTIONS_SEGACDSRAMSIZE + 6)
#define IDM_OPTIONS_SEGACDSRAMSIZE_256KB	(IDM_OPTIONS_SEGACDSRAMSIZE + 7)
#define IDM_OPTIONS_SEGACDSRAMSIZE_512KB	(IDM_OPTIONS_SEGACDSRAMSIZE + 8)
