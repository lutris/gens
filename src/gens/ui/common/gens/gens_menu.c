...
static struct GensMenuItem_t gmiFile[] =
{
	{IDM_FILE_OPENROM,	GMF_ICON_STOCK,		"&Open ROM...",		NULL,	GMAM_CTRL, 'O', IDIM_OPEN},
	{IDM_FILE_BOOTCD,	GMF_ICON_STOCK,		"&Boot CD",		NULL,	GMAM_CTRL, 'B', IDIM_CDROM},
	{IDM_FILE_NETPLAY,	GMF_ICON_FILE,		"&Netplay",		NULL,	0, 0, IDIM_NETPLAY},
	{IDM_FILE_ROMHISTORY,	GMF_ICON_FILE | GMF_ITEM_SUBMENU, "ROM &History", NULL, 0, 0, IDIM_ROMHISTORY},
	{IDM_FILE_CLOSEROM,	GMF_ICON_STOCK,		"&Close ROM",		NULL,	GMAM_CTRL, 'W', IDIM_CLOSE},
	{IDM_SEPARATOR,		GMF_ITEM_SEPARATOR,	NULL,			NULL,	0, 0, 0},
	{IDM_FILE_GAMEGENIE,	GMF_ICON_FILE,		"&Game Genie",		NULL,	GMAM_CTRL, 'G', IDIM_GAME_GENIE},
	{IDM_SEPARATOR,		GMF_ITEM_SEPARATOR,	NULL,			NULL,	0, 0, 0},
	{IDM_FILE_LOADSTATE,	GMF_ICON_STOCK,		"&Load State...",	NULL,	GMAM_SHIFT, GMAK_F8, IDIM_OPEN},
	{IDM_FILE_SAVESTATE,	GMF_ICON_STOCK,		"&Save State As...",	NULL,	GMAM_SHIFT, GMAK_F5, IDIM_SAVE_AS},
	{IDM_FILE_QUICKLOAD,	GMF_ICON_STOCK,		"Quick Load",		NULL,	0, GMAK_F8, IDIM_REFRESH},
	{IDM_FILE_QUICKSAVE,	GMF_ICON_STOCK,		"Quick Save",		NULL,	0, GMAK_F5, IDIM_SAVE},
	{IDM_FILE_CHANGESTATE,	GMF_ICON_STOCK | GMF_ITEM_SUBMENU, "Change State", &gmiFile_ChgState[0], 0, 0, IDIM_REVERT},
	{IDM_SEPARATOR,		GMF_ITEM_SEPARATOR,	NULL,			NULL,	0, 0, 0},
#ifdef GENS_OS_WIN32
	{IDM_FILE_EXIT,		GMF_ICON_STOCK,		"E&xit",		NULL,	GMAM_CTRL, 'Q', IDIM_QUIT},
#else /* !GENS_OS_WIN32 */
 	{IDM_FILE_QUIT,		GMF_ICON_STOCK,		"&Quit",		NULL,	GMAM_CTRL, 'Q', IDIM_QUIT},
#endif /* GENS_OS_WIN32 */
	{0, 0, NULL, NULL, 0, 0, 0}
};
...
static struct GensMenuItem_t gmiGraphics[] =
{
	{IDM_GRAPHICS_FULLSCREEN,	GMF_ICON_STOCK,		"&Full Screen",			NULL,	GMAM_ALT, GMAK_ENTER, IDIM_FULLSCREEN},
	...
	{IDM_SEPARATOR,			GMF_ITEM_SEPARATOR,	NULL,				NULL,	0, 0, 0},
#endif /* GENS_OS_UNIX */
	{IDM_GRAPHICS_COLORADJUST,	GMF_ICON_STOCK,		"Color Adjust...",		NULL,	0, 0, IDIM_COLOR_ADJUST},
	{IDM_GRAPHICS_RENDER,		GMF_ICON_FILE | GMF_ITEM_SUBMENU, "&Render",		NULL,	0, 0, IDIM_RENDER},
	{IDM_SEPARATOR,			GMF_ITEM_SEPARATOR,	NULL,				NULL,	0, 0, 0},
	{IDM_GRAPHICS_SPRITELIMIT,	GMF_ITEM_CHECK,		"Sprite Limit",			NULL,	0, 0, 0},
	{IDM_SEPARATOR,			GMF_ITEM_SEPARATOR,	NULL,				NULL,	0, 0, 0},
	{IDM_GRAPHICS_FRAMESKIP,	GMF_ICON_FILE | GMF_ITEM_SUBMENU, "Frame Skip",		&gmiGraphics_FrameSkip[0], 0, 0, IDIM_FRAMESKIP},
	{IDM_GRAPHICS_SCREENSHOT,	GMF_ICON_STOCK,		"Screen Shot",			NULL,	GMAM_SHIFT, GMAK_BACKSPACE, IDIM_SCREENSHOT},
	{0, 0, NULL, NULL, 0, 0, 0}
};
...
static struct GensMenuItem_t gmiGraphics_GLRes[] =
{
	{IDM_GRAPHICS_OPENGL_RES_320,		GMF_ITEM_RADIO,		"320x240",	NULL,	0, 0, 0},
	{IDM_GRAPHICS_OPENGL_RES_640,		GMF_ITEM_RADIO,		"640x480",	NULL,	0, 0, 0},
	{IDM_GRAPHICS_OPENGL_RES_800,		GMF_ITEM_RADIO,		"800x600",	NULL,	0, 0, 0},
	{IDM_GRAPHICS_OPENGL_RES_1024,		GMF_ITEM_RADIO,		"1024x768",	NULL,	0, 0, 0},
...
static struct GensMenuItem_t gmiCPU[] =
{
	...
	{IDM_SEPARATOR,			GMF_ITEM_SEPARATOR,	NULL,				NULL,	0, 0, 0},
	{IDM_CPU_HARDRESET,		GMF_ICON_STOCK,		"Hard &Reset",			NULL,	0, GMAK_TAB, IDIM_RESET},
...
static struct GensMenuItem_t gmiOptions[] =
{
	{IDM_OPTIONS_GENERAL,		GMF_ICON_FILE,		"&General Options...",	NULL, 0, 0, IDIM_GENERAL_OPTIONS},
	{IDM_OPTIONS_JOYPADS,		GMF_ICON_FILE,		"&Joypads...",		NULL, 0, 0, IDIM_JOYPADS},
	{IDM_OPTIONS_DIRECTORIES,	GMF_ICON_FILE,		"&Directories...",	NULL, 0, 0, IDIM_DIRECTORIES},
	{IDM_OPTIONS_BIOSMISCFILES,	GMF_ICON_FILE,		"&BIOS/Misc Files...",	NULL, 0, 0, IDIM_BIOSMISCFILES},
	{IDM_SEPARATOR,			GMF_ITEM_SEPARATOR,	NULL,			NULL, 0, 0, 0},
#ifdef GENS_CDROM
	{IDM_OPTIONS_CURRENT_CD_DRIVE,	GMF_ICON_STOCK,		"Current &CD Drive...",	NULL, 0, 0, IDIM_CDROM_DRIVE},
#endif /* GENS_CDROM */
	{IDM_OPTIONS_SEGACDSRAMSIZE,	GMF_ICON_FILE | GMF_ITEM_SUBMENU, "Sega CD S&RAM Size", &gmiOptions_SegaCDSRAMSize[0], 0, 0, IDIM_MEMORY},
	{IDM_SEPARATOR,			GMF_ITEM_SEPARATOR,	NULL,			NULL, 0, 0, 0},
	{IDM_OPTIONS_LOADCONFIG,	GMF_ICON_STOCK,		"&Load Config...",	NULL, 0, 0, IDIM_OPEN},
	{IDM_OPTIONS_SAVECONFIGAS,	GMF_ICON_STOCK,		"&Save Config As...",	NULL, 0, 0, IDIM_SAVE_AS},
	{0, 0, NULL, NULL, 0, 0, 0}
};
...
static struct GensMenuItem_t gmiHelp[] =
{
	{IDM_HELP_ABOUT,	GMF_ICON_STOCK,		"&About",	NULL,	0, 0, IDIM_HELP},
	{0, 0, NULL, NULL, 0, 0, 0}
};
