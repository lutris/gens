...
#ifndef GENS_X86_ASM
/**
 * mdp_render_scanline_25_cpp_int: Blits the image to the screen, 2x size, 25% scanlines.
...
static inline void mdp_render_scanline_25_cpp_int(pixel *destScreen, pixel *mdScreen,
...
#else /* !GENS_X86_ASM */
		mdp_render_scanline_25_cpp_int(
			    (uint16_t*)renderInfo->destScreen,
			    (uint16_t*)renderInfo->mdScreen,
			    renderInfo->width, renderInfo->height,
			    renderInfo->pitch, renderInfo->offset,
