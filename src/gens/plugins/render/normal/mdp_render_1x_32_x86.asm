...
%ifdef __OBJ_ELF
%define _mdp_render_1x_32_x86 mdp_render_1x_32_x86
%define _mdp_render_1x_32_x86_mmx mdp_render_1x_32_x86_mmx
%define _mdp_render_1x_32_x86_sse2 mdp_render_1x_32_x86_sse2
%endif
...
section .text align=64
	...
	;************************************************************************
	; void mdp_render_1x_32_x86(uint16_t *destScreen, uint16_t *mdScreen,
	;			    int width, int height, int pitch, int offset);
	global _mdp_render_1x_32_x86
	_mdp_render_1x_32_x86:
	...
	;************************************************************************
	; void mdp_render_1x_32_x86_mmx(uint16_t *destScreen, uint16_t *mdScreen,
	;				int width, int height, int pitch, int offset);
	global _mdp_render_1x_32_x86_mmx
	_mdp_render_1x_32_x86_mmx:
	...
	;************************************************************************
	; void mdp_render_1x_32_x86_sse2(uint16_t *destScreen, uint16_t *mdScreen,
	;				 int width, int height, int pitch, int offset);
	global _mdp_render_1x_32_x86_sse2
	_mdp_render_1x_32_x86_sse2:
