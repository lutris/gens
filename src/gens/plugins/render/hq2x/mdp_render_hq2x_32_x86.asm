...
%define _mdp_render_hq2x_32_x86_mmx mdp_render_hq2x_32_x86_mmx
%endif
...
arg_offset	equ 28
	...
	;************************************************************************
	; void mdp_render_hq2x_32_x86_mmx(uint32_t *destScreen, uint16_t *mdScreen,
	;				  int width, int height, int pitch, int offset);
	global _mdp_render_hq2x_32_x86_mmx
	_mdp_render_hq2x_32_x86_mmx:
...
.noflag8:
	...
	jnz     .testflag1
	mov     ecx, [cross]
	mov     ebx, [_mdp_render_hq2x_LUT16to32]
	mov     eax, [ebx + eax * 4]
