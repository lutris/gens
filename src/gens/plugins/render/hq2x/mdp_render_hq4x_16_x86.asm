...
%macro TestDiff 2
	...
	mov	edx, [%1]
	shl	edx, 2
	add	edx, [_mdp_render_hq2x_RGBtoYUV]
	movd	mm1, [edx]
	movq	mm5, mm1
	mov	edx, [%2]
	shl	edx, 2
...
%macro Interp3 3
	mov		eax, [_mdp_render_hq2x_LUT16to32]
	mov		edx, %2
	movd		mm1, [eax + edx * 4]
	mov		edx, %3
	movd		mm2, [eax + edx * 4]
...
.LoopY:
	...
	sub	ecx, 2			; x={arg_width-2, arg_width-1} are special cases.
