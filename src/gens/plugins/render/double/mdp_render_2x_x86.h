...
void mdp_render_2x_16_x86_sse2(uint16_t *destScreen, uint16_t *mdScreen, int width, int height, int pitch, int offset);
...
void mdp_render_2x_32_x86_sse2(uint32_t *destScreen, uint32_t *mdScreen, int width, int height, int pitch, int offset);
