...
#define MDP_ERR_INVALID_LICENSE			(0x0005 | MDP_ERR_GENERAL_CATEGORY)
#define	MDP_ERR_FUNCTION_NOT_IMPLEMENTED	(0x0101 | MDP_ERR_GENERAL_CATEGORY)
#define MDP_ERR_UNKNOWN_PTRID			(0x0102 | MDP_ERR_GENERAL_CATEGORY)
#define	MDP_ERR_UNKNOWN_VALID			(0x0103 | MDP_ERR_GENERAL_CATEGORY)
...
#define MDP_ERR_ROM_NOT_LOADED			(0x0106 | MDP_ERR_GENERAL_CATEGORY)
#define MDP_ERR_UNKNOWN				(0xFFFF | MDP_ERR_GENERAL_CATEGORY)
...
/* Memory errors. */
#define MDP_ERR_MEM_CATEGORY			(0x0002 << 16)
#define MDP_ERR_MEM_UNKNOWN			(0x0000 | MDP_ERR_MEM_CATEGORY)
#define MDP_ERR_MEM_INVALID_MEMID		(0x0001 | MDP_ERR_MEM_CATEGORY)
#define MDP_ERR_MEM_NOT_ALLOCATED		(0x0002 | MDP_ERR_MEM_CATEGORY)
#define MDP_ERR_MEM_OUT_OF_RANGE		(0x0003 | MDP_ERR_MEM_CATEGORY)
#define MDP_ERR_MEM_NOT_RESIZABLE		(0x0004 | MDP_ERR_MEM_CATEGORY)
#define MDP_ERR_MEM_UNALIGNED			(0x0005 | MDP_ERR_MEM_CATEGORY)

/* Menu errors. */
#define MDP_ERR_MENU_CATEGORY			(0x0003 << 16)
...
/* Event errors. */
#define MDP_ERR_EVENT_CATEGORY			(0x0004 << 16)
...
/* Window errors. */
#define MDP_ERR_WINDOW_CATEGORY			(0x0005 << 16)
