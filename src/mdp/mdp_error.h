...
#define MDP_ERR_UNKNOWN_PTRID			((uint32_t)(0x0102 | MDP_ERR_GENERAL_CATEGORY))
#define	MDP_ERR_UNKNOWN_VALID			((uint32_t)(0x0103 | MDP_ERR_GENERAL_CATEGORY))
#define	MDP_ERR_VAL_READ_ONLY			((uint32_t)(0x0104 | MDP_ERR_GENERAL_CATEGORY))
#define MDP_ERR_UNSUPPORTED_UI			((uint32_t)(0x0105 | MDP_ERR_GENERAL_CATEGORY))
#define MDP_ERR_ROM_NOT_LOADED			((uint32_t)(0x0106 | MDP_ERR_GENERAL_CATEGORY))
