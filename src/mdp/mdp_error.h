...
#define MDP_ERR_RENDER_UNSUPPORTED_FLAG		((uint32_t)(0x0002 | MDP_ERR_RENDER_CATEGORY))
#define MDP_ERR_RENDER_UNSUPPORTED_VMODE	((uint32_t)(0x0003 | MDP_ERR_RENDER_CATEGORY))
