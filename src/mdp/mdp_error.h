...
#define MDP_ERR_UNKNOWN_MEMID			(0x0102 | MDP_ERR_GENERAL_CATEGORY)
#define MDP_ERR_UNKNOWN_PTRID			(0x0103 | MDP_ERR_GENERAL_CATEGORY)
#define	MDP_ERR_UNKNOWN_VALID			(0x0104 | MDP_ERR_GENERAL_CATEGORY)
#define	MDP_ERR_VAL_READ_ONLY			(0x0105 | MDP_ERR_GENERAL_CATEGORY)
