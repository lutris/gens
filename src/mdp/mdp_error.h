...
#define MDP_ERR_UNKNOWN_PTRID			(0x0001 | MDP_ERR_GENERAL_CATEGORY)
#define	MDP_ERR_FUNCTION_NOT_IMPLEMENTED	(0x0002 | MDP_ERR_GENERAL_CATEGORY)
#define	MDP_ERR_UNKNOWN_VALID			(0x0003 | MDP_ERR_GENERAL_CATEGORY)
#define	MDP_ERR_VAL_READ_ONLY			(0x0004 | MDP_ERR_GENERAL_CATEGORY)
#define MDP_ERR_UNSUPPORTED_UI			(0x0005 | MDP_ERR_GENERAL_CATEGORY)
