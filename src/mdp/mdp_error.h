...
#define MDP_ERR_DUPLICATE_UUID			((uint32_t)(0x0004 | MDP_ERR_GENERAL_CATEGORY))
#define MDP_ERR_NEEDS_CPUFLAGS			((uint32_t)(0x0005 | MDP_ERR_GENERAL_CATEGORY))
#define MDP_ERR_INVALID_LICENSE			((uint32_t)(0x0006 | MDP_ERR_GENERAL_CATEGORY))
...
#define MDP_ERR_Z_ARCHIVE_NOT_SUPPORTED		((uint32_t)(0x0003 | MDP_ERR_Z_CATEGORY))
#define MDP_ERR_Z_NO_FILES_IN_ARCHIVE		((uint32_t)(0x0004 | MDP_ERR_Z_CATEGORY))
#define MDP_ERR_Z_FILE_NOT_FOUND_IN_ARCHIVE	((uint32_t)(0x0005 | MDP_ERR_Z_CATEGORY))
