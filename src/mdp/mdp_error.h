...
// General error codes.
#define MDP_ERR_GENERAL_CATEGORY		(0x0000 << 4)
...
// Renderer errors.
#define MDP_ERR_RENDER_CATEGORY			(0x0001 << 4)
#define MDP_ERR_RENDER_UNKNOWN			(0x0000 | MDP_ERR_RENDER_CATEGORY)
#define MDP_ERR_RENDER_INVALID_RENDERINFO	(0x0002 | MDP_ERR_RENDER_CATEGORY)
