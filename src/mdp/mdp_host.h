...
// MDP_LAYER_OPTIONS: Layer options bits.
#define MDP_LAYER_OPTIONS_SCROLLA_LOW		(1 << 0)
#define MDP_LAYER_OPTIONS_SCROLLA_HIGH		(1 << 1)
#define MDP_LAYER_OPTIONS_SCROLLA_SWAP		(1 << 2)
#define MDP_LAYER_OPTIONS_SCROLLB_LOW		(1 << 3)
#define MDP_LAYER_OPTIONS_SCROLLB_HIGH		(1 << 4)
#define MDP_LAYER_OPTIONS_SCROLLB_SWAP		(1 << 5)
#define MDP_LAYER_OPTIONS_SPRITE_LOW		(1 << 6)
#define MDP_LAYER_OPTIONS_SPRITE_HIGH		(1 << 7)
#define MDP_LAYER_OPTIONS_SPRITE_SWAP		(1 << 8)
#define MDP_LAYER_OPTIONS_SPRITE_ALWAYSONTOP	(1 << 9)
#define	MDP_LAYER_OPTIONS_PALETTE_LOCK		(1 << 10)

#define MDP_LAYER_OPTIONS_DEFAULT	  \
	(MDP_LAYER_OPTIONS_SCROLLA_LOW	| \
	 MDP_LAYER_OPTIONS_SCROLLA_HIGH	| \
	 MDP_LAYER_OPTIONS_SCROLLB_LOW	| \
	 MDP_LAYER_OPTIONS_SCROLLB_HIGH	| \
	 MDP_LAYER_OPTIONS_SPRITE_LOW	| \
	 MDP_LAYER_OPTIONS_SPRITE_HIGH)
