 ...
 */
void MDP_FNCALL scale2x_16_def(uint16_t* dst0, uint16_t* dst1,
 ...
 * \param dst1 Second destination row, double length in pixels.
 */
void MDP_FNCALL scale2x_32_def(uint32_t* dst0, uint32_t* dst1,
 ...
 * \param dst1 Second destination row, double length in pixels.
 */
void MDP_FNCALL scale2x_16_mmx(uint16_t* dst0, uint16_t* dst1,
			       const uint16_t* src0, const uint16_t* src1,
			       const uint16_t* src2, unsigned int count)
{
 ...
 * \param dst1 Second destination row, double length in pixels.
 */
void MDP_FNCALL scale2x_32_mmx(uint32_t* dst0, uint32_t* dst1,
			       const uint32_t* src0, const uint32_t* src1,
