 ...
 */
void MDP_FNCALL mdp_render_interpolated_scanline_25_init(MDP_Host_t *hostSrv)
{
	// Save the MDP Host Services pointer.
	mdp_render_interpolated_scanline_25_hostSrv = hostSrv;
	
	// Register the renderer.
	mdp_render_interpolated_scanline_25_hostSrv->register_renderer(&mdp, &mdp_render_t);
}
 ...
 */
void MDP_FNCALL mdp_render_interpolated_scanline_25_end(void)
{
	if (mdp_render_interpolated_scanline_25_hostSrv)
	{
		// Unregister the renderer.
		mdp_render_interpolated_scanline_25_hostSrv->unregister_renderer(&mdp, &mdp_render_t);
	}
}
