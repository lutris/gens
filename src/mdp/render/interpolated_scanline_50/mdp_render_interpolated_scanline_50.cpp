...
// MDP Host Services.
static const mdp_host_t *mdp_render_interpolated_scanline_50_host_srv = NULL;
 ...
 */
int MDP_FNCALL mdp_render_interpolated_scanline_50_init(const mdp_host_t *host_srv)
{
...
int MDP_FNCALL mdp_render_interpolated_scanline_50_cpp(const mdp_render_info_t *render_info)
{
	if (!render_info)
