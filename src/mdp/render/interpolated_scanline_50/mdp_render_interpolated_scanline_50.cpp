 ...
 */
int MDP_FNCALL mdp_render_interpolated_scanline_50_init(MDP_Host_t *hostSrv)
{
	// Save the MDP Host Services pointer.
	mdp_render_interpolated_scanline_50_hostSrv = hostSrv;
	
	// Register the renderer.
	mdp_render_interpolated_scanline_50_hostSrv->renderer_register(&mdp, &mdp_render_t);
...
int MDP_FNCALL mdp_render_interpolated_scanline_50_end(void)
{
	...
	mdp_render_interpolated_scanline_50_hostSrv->renderer_unregister(&mdp, &mdp_render_t);
...
int MDP_FNCALL mdp_render_interpolated_scanline_50_cpp(MDP_Render_Info_t *renderInfo)
{
	if (!renderInfo)
