...
DLL_LOCAL int MDP_FNCALL mdp_render_interpolated_scanline_50_init(mdp_host_t *host_srv);
DLL_LOCAL int MDP_FNCALL mdp_render_interpolated_scanline_50_end(void);
DLL_LOCAL int MDP_FNCALL mdp_render_interpolated_scanline_50_cpp(mdp_render_info_t *render_info);
