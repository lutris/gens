...
void MDP_FNCALL mdp_render_interpolated_scanline_init(MDP_Host_t *hostSrv)
{
	...
	mdp_render_interpolated_scanline_hostSrv->register_renderer(&mdp, &mdp_render_t);
}
...
void MDP_FNCALL mdp_render_interpolated_scanline_end(void)
{
	if (mdp_render_interpolated_scanline_hostSrv)
	{
		...
		mdp_render_interpolated_scanline_hostSrv->unregister_renderer(&mdp, &mdp_render_t);
	}
}
